...
#
"""Null stubs for MoE Offloading hooks.

These are used when the vllm-moe-offload-ascend plugin is not installed.
All operations are safe no-ops that keep the execution on the normal
(non-offload) code path.
"""
